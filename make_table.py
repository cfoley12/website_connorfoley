...
def main():
	...
	# create a RACE table
	cursor.execute("CREATE TABLE complied_races (place int, year varchar(80), name varchar(80), time varchar(80), school varchar(80), race varchar(80), course varchar(80));")

...
def main():
	...
	# create a RACE table
	cursor.execute("CREATE TABLE uncle (place int, year varchar(80), name varchar(80), time varchar(80), school varchar(80), race_name varchar(80), speed_rating varchar(80));")
